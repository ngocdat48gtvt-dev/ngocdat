...
import { filterTngtEntries } from "../utils/tngtFormat";
import { useRoadWorkspace } from "../context/RoadWorkspaceContext";

const SIDEBAR_WIDTH = 260;

export default function SoTngt({ onGoEdit, storageTick = 0 }) {
      ...
      >
        <div className="sidebar-sticky-head">
          ...
          <p className="sonhatky-day-summary">
            ...
            {data.length > 0 ? ` · ${data.length} vụ TNGT` : " · Chưa có ghi chép"}
          </p>
      ...
      <main className="nhaplieu-review-pane">
        <div className="nhatky-review">
          <div className="nhatky-review-canvas nhatky-review-canvas--tngt">
            <TngtSheet yearMonth={yearMonth} reportMeta={reportMeta} entries={data} />
          </div>
        </div>
      </main>
    </div>
